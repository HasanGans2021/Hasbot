...
* UBAH AJA SEMAU KALIAN, GW BAIK:VV
*/
const XPTN = 'HasanBot'; // JANGAN DI UBAH NNTI EROR
const instagram = 'https://instagram.com/hasan_yahya321_'; // JANGAN DI UBAH NNTI EROR
const nomer = 'https://wa.me/6285654783525'; // JANGAN DI UBAH NANTI EROR
const aktif = 'TERGANTUNG OWNER'; // DI GANTI AUTO EROR
const groupwa = 'https://chat.whatsapp.com/D8YpSLQWqvh6AYLyn5HnSB'; // DI GANTI AUTO EROR
const youtube = 'https://www.youtube.com'; // DI GANTI AUTO EROR
//
...
conn.sendMessage(id, 'Waalaikumsalam, Ketik !menu untuk melihat fitur bot kami' ,MessageType.text);
}
else if (text == 'salam'){
conn.sendMessage(id, 'Waalaikumsalam, Ketik !menu untuk melihat fitur bot kami' ,MessageType.text);
}
...
conn.sendMessage(id, 'Ya, Ada yang bisa saya bantu?, Ketik !menu untuk melihat fitur bot kami' ,MessageType.text);
}
else if (text == 'P'){
conn.sendMessage(id, 'Ya, Ada yang bisa saya bantu?, Ketik !menu untuk melihat fitur bot kami' ,MessageType.text);
}
...
conn.sendMessage(id, 'Owner FADHIL ID wa.me/6283102650464' ,MessageType.text);
}
else if (text == 'Fadhil'){
conn.sendMessage(id, 'itu ownerku, ada yang bisa di bantu?' ,MessageType.text);
}
else if (text == 'Jihan'){
conn.sendMessage(id, 'itu patnernya ownerku, ada yang bisa kami bantu?' ,MessageType.text);
}
else if (text == 'bangsat'){
conn.sendMessage(id, 'toxic terdeteksi, hati�' ,MessageType.text);
}
else if (text == 'Ngentod'){
conn.sendMessage(id, 'Pengin ngentod?' ,MessageType.text);
}
else if (text == 'Anjing'){
conn.sendMessage(id, 'Jangan toxic anjing, kontol, memek, taik, bangsad' ,MessageType.text);
}
else if (text == 'Bacot'){
conn.sendMessage(id, 'lu yang bacot_-' ,MessageType.text);
}
else if (text == 'Test'){
conn.sendMessage(id, 'Test Bot Aktif ketik perintah *!menu* untuk melihat fitur bot kami' ,MessageType.text);
}
else if (text == 'Hai'){
conn.sendMessage(id, 'Ya, Ada yang bisa saya bantu?, Ketik *!menu* untuk melihat fitur bot kami' ,MessageType.text);
}
else if (text == '!ttp'){
conn.sendMessage(id, ' *COMMAND PREMIUM CHAT WA https://wa.me/6283102650464* ' ,MessageType.text);
}
else if (text == 'Woi'){
conn.sendMessage(id, 'Ya, Ada yang bisa saya bantu?, Ketik *!menu* untuk melihat fitur bot kami' ,MessageType.text);
}
...
conn.sendMessage(id, 'Ya? Bot Aktif untuk melohat fitur kami ketikan perintah *!menu*' ,MessageType.text);
}
else if (text == 'Gan'){
conn.sendMessage(id, 'Ya, Ada yang bisa saya bantu?, Ketik *!menu* untuk melihat fitur bot kami' ,MessageType.text);
}
...
conn.sendMessage(id, 'kawan1 MyBot tidak ada.' ,MessageType.text);
}
else if (text == '!coowner'){
conn.sendMessage(id, 'kawan2 MyBot tidak ada.' ,MessageType.text);
}
else if (text == '!groupbot'){
conn.sendMessage(id, 'https://chat.whatsapp.com/D8YpSLQWqvh6AYLyn5HnSB' ,MessageType.text);
}
else if (text == '!tools1'){
  ...
  var teks = text.replace(/!nulis /, '')
    ...
    .then((res) => {
      imageToBase64(res.data.result)
        .then(
          (ress) => {
            conn.sendMessage(id, 'Sedang Proses...⏳ Tunggu Sebentar...‼️', MessageType.text)
...
axios.get(`https://api.haipbis.xyz/randomcooltext?text=${teks}`).then((res) => {
	conn.sendMessage(id, 'Sedang Proses... Tunggu Sebentar...', MessageType.text)
...
conn.sendMessage(id, ' _TERIMAKASIH TELAH MENGGUNAKAN MYBOT *SILAHKAN PILIH FITUR BOT KAMI YA KAK*' ,MessageType.text);
}
else if (text == '!tools1'){
conn.sendMessage(id, ' _🗣️Thanks Telah Menggunakan BOT *_MYBOT_* , Follow Instagram Mimin Yah😻 : https://instagram.com/@nur.fdhl_' ,MessageType.text);
}
else if (text == '!help'){
conn.sendMessage(id, ' untuk melihat fitur bot kami silahkan ketik perintah !menu' ,MessageType.text);
}
else if (text == '!tool2'){
conn.sendMessage(id, ' _🗣️Thanks Telah Menggunakan BOT *_MYBOT_* , Follow Instagram Mimin Yah😻 : https://instagram.com/@nur.fdhl_' ,MessageType.text);
}
...
//ubah aja semau kalian gw baik:vv Fadhil id
